...
class ViewShoping extends Component {
  ...
  toggleModal = (id,name,categoriaid,tipodato,description,imagen) => {
    
    //id, cod, des, category, price, description, popular, imageUrls) => {
    this.setState({
  ...
  onSubmit(e) {
    ...
    console.log(this.state.id,tipoData)
    this.props.updateCurrentShoping(tipoData.id, tipoData);
    this.toggleModalfin();
          ...
          currentTodos.map(l1 => (
            ...
            <TableRow key={l1.id} className={classes.tableBodyRow}>
              ...
              <TableCell className={classes.tableCell}>
                <button type="button" onClick={this.toggleModal.bind(this,l1.id,l1.name, l1.categoriaid, l1.tipodato, l1.description, l1.imagen)} className="btn btn-primary  mt-4 01579b light-blue darken-2"  >Editar</button>

              </TableCell>

              <TableCell className={classes.tableCell}>
                <button type="button" className="btn btn-danger  mt-4 01579b red darken-2" onClick={this.onDeleteClick.bind(this, l1.id)} >Borrar</button>

              </TableCell>
              <TableCell className={classes.tableCell}>{l1.id}</TableCell>
              <TableCell className={classes.tableCell}>{l1.name}</TableCell>
              <TableCell className={classes.tableCell}>{l1.categoriaid}</TableCell>
              <TableCell className={classes.tableCell}>{l1.tipodato}</TableCell>
